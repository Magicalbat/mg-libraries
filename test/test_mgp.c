...
/*
Win32 Compile:
clang test/test_mgp.c test/mgp_impl.c -lgdi32 -luser32 -lopengl32 -o test_mgp.exe

Linux Compile:
clang test/test_mgp.c test/mgp_impl.c -lX11 -lGL -lm -lGLX -o test_mgp 
*/
...
int main(void) {
    ...
    mgp_lines_ex(NUM, xs, ys, 3.0f, MGP_LINE_SOLID, (mgp_vec4f){ 0 }, NULL, MGP_STR8("Line 2"));
